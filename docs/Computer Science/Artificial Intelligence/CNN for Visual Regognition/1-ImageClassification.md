...
![png](_1-ImageClassification_files/output_4_1.png)
...
```
    ...
    /var/folders/vr/l1210zqn4vv2f6qs78lpkbww0000gn/T/ipykernel_8165/195087602.py:6: DeprecationWarning: elementwise comparison failed; this will raise an error in the future.
      print("accuracy: %f", np.mean(YpredTest == testy))
```
...
```py title="nearest_neighbor_image_classifier.py"
import numpy as np
