...
// TODO
Docusaurus renders LaTeX content using KaTex, however Jupyter Notebooks renders content in jupyter notebooks using MathJax.
...
// TODO SVG to copy text but then backgound isn't transparent???
