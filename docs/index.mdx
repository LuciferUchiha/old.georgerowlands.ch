...
supports other things. Importantly however is that the jupyter notebooks get converted to mardown and therefore in the end it will only be rendered in KaTeX.
...
can be rendered by KaTeX will be readable.
